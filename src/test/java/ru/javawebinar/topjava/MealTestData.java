...
public class MealTestData {
    ...
    public static final Meal USER_MEAL_1 = new Meal(MEAL_ID + 2,
            LocalDateTime.of(2015, Month.MAY, 30, 10, 0),"Завтрак", 500);
    public static final Meal USER_MEAL_2 = new Meal(MEAL_ID + 3,
            LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед", 1000);
    public static final Meal USER_MEAL_3 = new Meal(MEAL_ID + 4,
            LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 500);
    public static final Meal USER_MEAL_4 = new Meal(MEAL_ID + 5,
            LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000);
    public static final Meal USER_MEAL_5 = new Meal(MEAL_ID + 6,
            LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500);
    public static final Meal USER_MEAL_6 = new Meal(MEAL_ID + 7,
            LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510);

    public static final Meal ADMIN_MEAL_1 = new Meal(MEAL_ID + 8,
            LocalDateTime.of(2012, Month.JANUARY, 23, 13, 0), "Lunch", 400);
    public static final Meal ADMIN_MEAL_2 = new Meal(MEAL_ID + 9,
