...
@NamedQueries({
        ...
        @NamedQuery(name= User.UPDATE_ENABLED, query = "UPDATE User u SET u.enabled=:enabled WHERE u.id=:id")
})
@Entity
...
public class User extends AbstractNamedEntity {
    ...
    public static final String UPDATE_ENABLED = "User.updateEnabled";
